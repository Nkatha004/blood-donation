...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 17, 2022 at 10:21 PM
...
--
ALTER TABLE `blood_details`
  MODIFY `blood_details_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `drive_booking`
  MODIFY `drive_booking_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `test_results`
  MODIFY `results_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
